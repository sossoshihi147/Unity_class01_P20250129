...
namespace OLIVER
{
    ...
    /// 2. Switch 判斷式
    /// </summary>
    public class Class_05_Selection : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (hp >= 10 && hp < 40)
            {
                Debug.Log("<color=#f00>快死掉了</color>");
            }
            else if (hp >= 40 && hp < 60)
            {
            ...
            {
                Debug.Log("<color=#ff0>健康狀態有狀況</color>");
            }
            else if (hp >= 80)
            {
                Debug.Log("<color=#7f0>血量安全</color>");
            }
            else if (hp == 0)
            {
